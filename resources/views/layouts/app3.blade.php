        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="http://127.0.0.1:8000/home">
                    <b class="logo-abbr"><img src="{{ asset('quixlab/images/logo.jpeg') }}" alt=""> </b>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                ...
                <li>
                    ...
                    <li>
                        <a class="has" href="http://127.0.0.1:8000/penduduk" aria-expanded="false">
                    ...
                    <li>
                        @can('manage-admins')
                        <a href="http://127.0.0.1:8000/calenderAdmin" aria-expanded="false">
                    ...
                    <li>
                        @can('manage-users')
                        <a href="http://127.0.0.1:8000/calenderPenduduk" aria-expanded="false">
                            <i class="icon-calender menu-icon"></i><span class="nav-text">Calender</span>
                        </a>
                        @endcan
                    </li>
